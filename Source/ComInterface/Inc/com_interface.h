...
/* Exported defines ----------------------------------------------------------*/
#define COM_EVENT_FLAG_REQU_GET 	(1<<0)
#define COM_EVENT_FLAG_COMPLETED 	(1<<1)
#define COM_EVENT_FLAG_ACK 				(1<<3)

#define COM_MAX_BYTE_CNT				50

#define COM_I2C_DATA(X)					((X)->comData.i2c)								//X represents address of COM_Handle object.
#define COM_I2C_HANDLE(X)				COM_I2C_DATA(X).comHandle
