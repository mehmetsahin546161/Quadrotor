...
#define AK8963_ADDRESS   		(0x69<<1)/*0xD1*/

#define MPU9250_I_AM				(0x71)
#define AK8963_I_AM					(0x48)

/* Accelerometer and Gyroscope Register Map */
...
#define MPU9250_ACCEL_SCALE_FACTOR	(16.0/32768.0)
#define MPU9250_GYRO_SCALE_FACTOR		(2000.0/32768.0)
#define AK8963_MAG_SCALE_FACTOR			(10.*4912./32760.0)
...
typedef struct
{
	...
	/* Raw Data */
	int16_t rawSignedAccel[3];
	int16_t rawSignedGyro[3];
	int16_t rawSignedMag[3];
	
	MPU9250_RawData 	rawAccel;
	MPU9250_RawData		rawGyro;
	AK8963_RawData		rawMag;
	
	/* Holds results of accelerometer and gyro self test result */
...
uint8_t MPU9250_WhoAmI(MPU9250_Handle * MPU9250);
void MPU9250_SelfTest(I2C_HandleTypeDef * i2cHandle, float * testResult);
void MPU9250_Calibrate(I2C_HandleTypeDef * i2cHandle, float * dest1, float * dest2);
